    ...
    <footer className="bg-[#012F60] text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {/* Atendimento */}
          <div>
            <h4 className="font-montserrat font-bold text-base mb-3 text-[#D9A642]">
              Atendimento
            </h4>
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <MessageCircle size={14} className="text-[#D9A642]" />
                <div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {/* Payment Methods */}
              <div>
                <p className="font-poppins text-xs mb-2 text-[#D9A642]">Formas de Pagamento:</p>
        ...
        {/* Bottom Section */}
        <div className="border-t border-blue-700 mt-6 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="font-poppins text-xs text-blue-200">
