...
const PromoBanner = () => {
  return (
    <section className="relative py-16 bg-gradient-to-r from-[#D9A642] to-[#F4C542] overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <p className="font-poppins text-lg md:text-xl text-[#012F60] mb-8 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a 
            href="https://wa.me/5531999999999?text=Quero%20personalizar%20minha%20camisa%20do%20Cruzeiro"
            className="bg-[#012F60] text-white px-8 py-4 rounded-lg font-montserrat font-bold text-lg hover:bg-[#0038A8] transform hover:scale-105 transition-all duration-300 shadow-lg"
          >
            ✨ Personalizar Agora
          </a>
          <div className="text-[#012F60] font-poppins">
            <span className="font-bold">Nome + Número</span> por apenas <span className="text-xl font-bold">+R$ 25,00</span>
          </div>
        </div>
      </div>
    </section>
