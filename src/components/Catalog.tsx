...
const Catalog = () => {
  ...
  const filters = ['Todos', '2025/26', '2024/25', '2023/24', '2022/23', '2021/22 Centenário', 'Retrô', 'Infantil', 'Treino', 'Agasalho'];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-6">
          ...
          <p className="font-poppins text-sm text-gray-600 max-w-2xl mx-auto">
            Encontre a camisa perfeita do Cabuloso. Modelos novos, retrô e edições especiais.
          </p>
        </div>
