...
const PromoBannerInauguration = () => {
  return (
    <section className="bg-gradient-to-r from-red-600 to-red-500 text-white py-2 px-4 shadow-lg">
      <div className="container mx-auto text-center max-w-6xl">
        <div className="flex items-center justify-center space-x-2">
          <span className="text-yellow-300 text-base">🎉</span>
          <p className="font-montserrat font-bold text-xs md:text-sm">
          ...
          <a 
            ...
            className="bg-yellow-400 text-red-600 px-2 py-1 rounded-full font-montserrat font-bold text-xs hover:bg-yellow-300 transition-colors ml-2"
          >
            Clique aqui
          </a>
        </div>
